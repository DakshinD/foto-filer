...
export default function Example() {
    return (
        ...
        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:bg-gray-800 dark:bg-gray-800 hover:bg-gray-500 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-700">
