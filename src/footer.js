...
export default function Example() {
    return (
      <div className='bg-gray-900 border-t-2 border-white/80'>
          <div className="container  m-auto grid grid-cols-1 text-center img-center py-8">
        <div className="m-auto grid grid-rows-3 gap-4 text-sm font-semibold leading-6 text-gray-300">
            ...
            <div>
              <p>Copyright © 2023 - All right reserved by FotoFiler, LLC</p>
            </div>
        </div>
