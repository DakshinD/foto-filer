          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-700">
                ...
                group photos, our AI algorithm utilizes facial recognition to give you customized folders containing pictures 
                of each individual, in seconds.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>
                Are you a photographer with thousands of just-edited pictures stuck on your hard drive? Or a high school senior with too 
                many graduation pictures to sort through? Seize control of your photos by organizing them by face and sending them to 
                each person, free of cost.
              </p>
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    making sure that everyone's information is safe.
                  </span>
                </li>
              </ul>
              <p className="mt-8">
                Whether it's sending pictures to your clients or sorting out your camera roll, FotoFiler is your 
                friend. 
              </p>
            </div>
          </div>
